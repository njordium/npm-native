...
detect_db_config() {
    ...
    # v1.1.23 (PR #6): SQLite containers have no DB_MYSQL_* env vars.
    # grep-no-match returns 1, pipefail propagates it, and the script died
    # before reaching the SQLite fallback below -- breaking every Docker
    # to Native migration for the common (default) SQLite case.
